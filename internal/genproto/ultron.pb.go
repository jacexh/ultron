...
const (
	EventType_PING               EventType = 0 // 心跳包
	EventType_CONNECTED          EventType = 1 //已连接
	EventType_DISCONNECT         EventType = 2 // 要求slave断开连接
	EventType_PLAN_STARTED       EventType = 3 // 测试计划开始
	EventType_PLAN_FINISHED      EventType = 4 // 测试计划结束
	EventType_PLAN_INTERRUPTED   EventType = 5 // 测试计划中断执行
	EventType_NEXT_STAGE_STARTED EventType = 6 // 开始执行计划中的下一阶段
	EventType_STATS_AGGREGATE    EventType = 7 // 上报统计对象
)
...
const (
	ResponseSubmit_ACCEPTED      ResponseSubmit_Result = 0 // 上报对象已经接收
	ResponseSubmit_BATCH_EXPIRED ResponseSubmit_Result = 1 // 批次已经结束
	ResponseSubmit_UNKNOWN_BATCH ResponseSubmit_Result = 2 // 批次ID错误3; // 批次ID错误
	ResponseSubmit_UNKNOWN_PLAN  ResponseSubmit_Result = 3 // 计划名称错误
)
...
func (x *ResponseSubmit) GetPlanName() string {
	if x != nil {
		return x.PlanName
	}
	return ""
...
var file_ultron_proto_rawDesc = []byte{
	...
	,
	...
	0x52, 0x45, 0x44, 0x10, 0x01, 0x12, 0x11, 0x0a, 0x0d, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e,
	0x5f, 0x42, 0x41, 0x54, 0x43, 0x48, 0x10, 0x02, 0x12, 0x10, 0x0a, 0x0c, 0x55, 0x4e, 0x4b, 0x4e,
	0x4f, 0x57, 0x4e, 0x5f, 0x50, 0x4c, 0x41, 0x4e, 0x10, 0x03, 0x2a, 0x9c, 0x01, 0x0a, 0x09, 0x45,
	...
	0x02, 0x12, 0x10, 0x0a, 0x0c, 0x50, 0x4c, 0x41, 0x4e, 0x5f, 0x53, 0x54, 0x41, 0x52, 0x54, 0x45,
	0x44, 0x10, 0x03, 0x12, 0x11, 0x0a, 0x0d, 0x50, 0x4c, 0x41, 0x4e, 0x5f, 0x46, 0x49, 0x4e, 0x49,
	0x53, 0x48, 0x45, 0x44, 0x10, 0x04, 0x12, 0x14, 0x0a, 0x10, 0x50, 0x4c, 0x41, 0x4e, 0x5f, 0x49,
	0x4e, 0x54, 0x45, 0x52, 0x52, 0x55, 0x50, 0x54, 0x45, 0x44, 0x10, 0x05, 0x12, 0x16, 0x0a, 0x12,
	0x4e, 0x45, 0x58, 0x54, 0x5f, 0x53, 0x54, 0x41, 0x47, 0x45, 0x5f, 0x53, 0x54, 0x41, 0x52, 0x54,
	0x45, 0x44, 0x10, 0x06, 0x12, 0x13, 0x0a, 0x0f, 0x53, 0x54, 0x41, 0x54, 0x53, 0x5f, 0x41, 0x47,
	0x47, 0x52, 0x45, 0x47, 0x41, 0x54, 0x45, 0x10, 0x07, 0x32, 0x93, 0x01, 0x0a, 0x0d, 0x55, 0x6c,
	...
	0x76, 0x65, 0x6e, 0x74, 0x22, 0x00, 0x30, 0x01, 0x12, 0x45, 0x0a, 0x06, 0x53, 0x75, 0x62, 0x6d,
	0x69, 0x74, 0x12, 0x1b, 0x2e, 0x77, 0x6f, 0x73, 0x61, 0x69, 0x2e, 0x75, 0x6c, 0x74, 0x72, 0x6f,
	0x6e, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x1a,
	0x1c, 0x2e, 0x77, 0x6f, 0x73, 0x61, 0x69, 0x2e, 0x75, 0x6c, 0x74, 0x72, 0x6f, 0x6e, 0x2e, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x22, 0x00, 0x42,
